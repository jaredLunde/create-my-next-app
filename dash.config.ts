...
export const themes = {
  ...
  dark: {
    shadow: {
      ...
      100: "0 0 0 1px rgba(255, 255, 255, 0.05)",
      200: "0 1px 2px 0 rgba(255, 255, 255, 0.05)",
      300: "0 4px 6px -1px rgba(255, 255, 255, 0.1), 0 2px 4px -1px rgba(255, 255, 255, 0.06)",
      400: "0 0 12px -3px rgba(255, 255, 255, 0.2), 0 0 6px -2px rgba(255, 255, 255, 0.2)",
      500: "0 0 15px -3px rgba(255, 255, 255, 0.2), 0 0 6px -2px rgba(255, 255, 255, 0.2)",
      600: "0 20px 25px -5px rgba(255, 255, 255, 0.1), 0 10px 10px -5px rgba(255, 255, 255, 0.04)",
      700: "0 25px 50px -12px rgba(255, 255, 255, 0.25)",
      inset: "inset 0 2px 4px 0 rgba(255, 255, 255, 0.06)",
      outline: "0 0 3px 3px rgba(66, 153, 225, 0.5)",
    },
